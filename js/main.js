...
$(function () {
  ...
  var swiperBest = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](matchBest, {
    slidesPerView: 'auto',
    freeMode: true,
    navigation: {
      nextEl: '.swiper-button-next',
  ...
  var swiperArticle = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](matchArticle, {
    slidesPerView: 'auto',
    freeMode: true,
    navigation: {
      nextEl: '.swiper-button-next',
  ...
  if (match.length != 0) {
    ...
    tabInit('.js-tab', '.js-tabList', '.js-tabItem', '.js-tabBlock'); // -- Match Interaction
    ...
    matchInfo.clone().appendTo('.match-head');
  } else {
    return;
  }
});
...
/* harmony import */ var _libs_countdowns_min__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../libs/countdowns.min */ "../libs/countdowns.min.js");
/* harmony import */ var _libs_countdowns_min__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_libs_countdowns_min__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _blocks_match_script__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../blocks/match/script */ "../blocks/match/script.js");
