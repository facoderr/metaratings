...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  ...
  var win = $(window);
  casinoFilter = $('.js-casino-filter'), casinoRatingList = $('.casino-rating-list');

  function scrollFilter() {
    var limitFilter = win.scrollTop() >= casinoRatingList.offset().top;
    casinoFilter.toggleClass('is-active', limitFilter);
  }
  ...
  casinoFilterItem.each(function () {
    if ($(this).parent().children().length > 4) {
      $(this).parents('.js-casino-target').find(casinoFilterSearch).show();
    } else {
      $(this).parents('.js-casino-target').find(casinoFilterSearch).hide();
    }
  });
  casinoFilterInput.on('keyup', function () {
    var input = $(this),
        value = input.val();
  ...
  var casinoRange = $('.js-casino-range'),
      casinoRangeInput = casinoRange.find('input'),
      casinoRangeVal = $('.js-casino-range-val'),
      casinoRangeMin = String(casinoRangeInput.attr('min')).replace(/(\d)(?=(\d{3})+([^\d]|$))/g, '$1 '),
      casinoRangeMax = String(casinoRangeInput.attr('max')).replace(/(\d)(?=(\d{3})+([^\d]|$))/g, '$1 ');
  $('.js-casino-range-min').html(casinoRangeMin + ' ₽');
  $('.js-casino-range-max').html(casinoRangeMax + ' ₽');
  casinoRange.on('input', function (e) {
    var val = e.target.value,
        valConvert = String(val).replace(/(\d)(?=(\d{3})+([^\d]|$))/g, '$1 ');
    casinoRangeVal.html(valConvert + ' ₽');
  });
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "../../node_modules/jquery/dist/jquery.js")))
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var _casino_filter_script__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../casino-filter/script */ "../blocks/casino-filter/script.js");
/* harmony import */ var _casino_filter_script__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_casino_filter_script__WEBPACK_IMPORTED_MODULE_0__);

$(function () {
  var casino = $('.js-casino');
  if (casino.length === 0) return;
  var casinoToggle = '.js-casino-toggle',
      casinoTarget = $('.js-casino-target');
  $(document).on('click', casinoToggle, function () {
    $(this).parents('.js-casino').toggleClass('is-active');
    $(this).parents('.js-casino').find(casinoToggle).toggleClass('is-active');
    $(this).parents('.js-casino').find(casinoTarget).slideToggle(300);
  });
});
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! jquery */ "../../node_modules/jquery/dist/jquery.js")))
...
/* harmony import */ var _blocks_sentiment_script__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ../blocks/sentiment/script */ "../blocks/sentiment/script.js");
/* harmony import */ var _blocks_sentiment_script__WEBPACK_IMPORTED_MODULE_33___default = /*#__PURE__*/__webpack_require__.n(_blocks_sentiment_script__WEBPACK_IMPORTED_MODULE_33__);
