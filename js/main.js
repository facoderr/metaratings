...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  ...
  modalShow.on('click', function () {
    ...
    $(modalTag).fadeIn().addClass('is-open');
    return false;
  });
...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  var toggleAcc = $('.js-overview-bk-acc'),
  ...
  toggleMore.on('click', function () {
    ...
    setTimeout(function () {
      toggleMore.parent().toggleClass('is-full');
    }, 300);
...
$(function () {
  var overviewBk = $('.overview-bk');
  if (overviewBk.length === 0) return;
  var win = $(window),
  ...
  function scrollEvent() {
    if (win.outerWidth() <= 1099) {
      if (win.scrollTop() >= anchorFix.offset().top) {
        anchorHead.addClass('is-fix');
        panelShow.addClass('is-active');
      } else {
        anchorHead.removeClass('is-fix');
        panelShow.removeClass('is-active');
      }
    } else {
      if (win.scrollTop() >= metaFix.offset().top - 75 || win.scrollTop() >= anchorFix.offset().top - 75) {
        metaFix.addClass('is-fix');
        anchorHead.addClass('is-fix');
        panelShow.addClass('is-active');
      } else {
        anchorHead.removeClass('is-fix');
        panelShow.removeClass('is-active');
        metaFix.removeClass('is-fix');
      }
    }
    ...
    anchorTab.each(function (i) {
      ...
      if (win.outerWidth() <= 1099) {
        if (win.scrollTop() >= anchorPos.offset().top - 55) {
          if (i === 0 || i === 1) {
  ...
  anchorTab.on('click', function () {
    ...
    if (win.outerWidth() <= 1099) {
      htmlBody.animate({
        scrollTop: anchorPos.offset().top - 40
      }, 1000);
    } else {
      htmlBody.animate({
        scrollTop: anchorPos.offset().top - 135
      }, 1000);
    }
  ...
  var scrollBlock = $('.js-overview-bk-scroll'),
      threshold = 32,
      clicked = false,
      allowClick = true,
      mouseX,
  ...
  scrollBlock.on({
    ...
    'mousedown': function mousedown(e) {
      clicked = true;
      el = $(e.target).closest(scrollBlock);
      mouseX = e.pageX;
      thX = e.pageX;
    },
...
/* harmony import */ var _blocks_banner_script__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_blocks_banner_script__WEBPACK_IMPORTED_MODULE_12__);
...
/* harmony import */ var _blocks_overview_bk_script__WEBPACK_IMPORTED_MODULE_18___default = /*#__PURE__*/__webpack_require__.n(_blocks_overview_bk_script__WEBPACK_IMPORTED_MODULE_18__);
