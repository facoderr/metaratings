...
/* WEBPACK VAR INJECTION */(function($) {$(function () {
  ...
  var list = feed.find('.feed-bar-list'),
  ...
  feed.find('.feed-setting-apply').on('click', function (e) {
    ...
    document.cookie = cookieName + '=' + encodeURIComponent(filter);
  ...
  function setFilterValues() {
    var types = getTypesByFilter(getCookie(cookieName)),
  ...
  */
  ...
  if (panel.length > 0) {
    ...
    feed.css('transition', 'all .5s ease-in-out');
...
$(function () {
  ...
  $('.js-forecast-timer').each(function () {
    var timer = $(this),
    ...
    interval = setInterval(function () {
      ...
      if (bEnd) {
        ...
        timer.html('<svg><use xlink:href="#clock"></use></svg>' + houses + ':' + minutes + ':' + seconds);
      }
    }, 1000);
  });
});
    ...
    return s(e, [{
      ...
      value: function value() {
        var e = this,
            t = this.base,
            n = this.menu;
        jQuery(".nav-menu-header", n).remove(), jQuery("a", n).removeClass("js-next").off("click"), n.css({
          height: "",
          "transition-duration": ""
        }), t.css({
          left: "",
          "transition-duration": ""
        }), n.find(".active").removeClass("active"), n.attr("class").split(" ").forEach(function (e) {
...
/* harmony import */ var _blocks_feed_bar_script__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_blocks_feed_bar_script__WEBPACK_IMPORTED_MODULE_6__);
...
/* harmony import */ var _blocks_footer_script__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_blocks_footer_script__WEBPACK_IMPORTED_MODULE_7__);
...
/* harmony import */ var _sprite__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./sprite */ "./sprite.js");
/* harmony import */ var _sprite__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(_sprite__WEBPACK_IMPORTED_MODULE_12__);
/* harmony import */ var _blocks_forecast_script__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../blocks/forecast/script */ "../blocks/forecast/script.js");
/* harmony import */ var _blocks_reward_script__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../blocks/reward/script */ "../blocks/reward/script.js");
/* harmony import */ var _blocks_feed_script__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../blocks/feed/script */ "../blocks/feed/script.js");
...
/** Пока не используемые скрпиты */
//import '../blocks/match/script'
//import '../blocks/widget/script'
//import '../blocks/review-publish/script'
//import '../blocks/sentiment/script'
  ...
  if ($(".news-infinitely").length) {
    ...
    $(window).scroll(function () {
      $('.hash').each(function () {
        ...
        var distance = top - $(this).offset().top + 45;
